...
public class AssemblyOscalMetadataLocation   {
  @JsonProperty("uuid")
  ...
  private AssemblyOscalMetadataAddress address = null;
  ...
  public AssemblyOscalMetadataLocation uuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AssemblyOscalMetadataLocation title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AssemblyOscalMetadataLocation address(AssemblyOscalMetadataAddress address) {
  ...
  @Schema(required = true, description = "")
    ...
    @Valid
    public AssemblyOscalMetadataAddress getAddress() {
    return address;
  }

  public void setAddress(AssemblyOscalMetadataAddress address) {
    this.address = address;
  }

  public AssemblyOscalMetadataLocation emailAddresses(List<String> emailAddresses) {
    this.emailAddresses = emailAddresses;
    return this;
  }

  public AssemblyOscalMetadataLocation addEmailAddressesItem(String emailAddressesItem) {
  ...
  public AssemblyOscalMetadataLocation telephoneNumbers(List<FieldOscalMetadataTelephoneNumber> telephoneNumbers) {
    this.telephoneNumbers = telephoneNumbers;
    return this;
  }

  public AssemblyOscalMetadataLocation addTelephoneNumbersItem(FieldOscalMetadataTelephoneNumber telephoneNumbersItem) {
  ...
  public AssemblyOscalMetadataLocation urls(List<String> urls) {
    this.urls = urls;
    return this;
  }

  public AssemblyOscalMetadataLocation addUrlsItem(String urlsItem) {
    if (this.urls == null) {
  ...
  public AssemblyOscalMetadataLocation props(List<AssemblyOscalMetadataProperty> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataLocation addPropsItem(AssemblyOscalMetadataProperty propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataLocation links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataLocation addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataLocation remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataLocation assemblyOscalMetadataLocation = (AssemblyOscalMetadataLocation) o;
    return Objects.equals(this.uuid, assemblyOscalMetadataLocation.uuid) &&
        Objects.equals(this.title, assemblyOscalMetadataLocation.title) &&
        Objects.equals(this.address, assemblyOscalMetadataLocation.address) &&
        Objects.equals(this.emailAddresses, assemblyOscalMetadataLocation.emailAddresses) &&
        Objects.equals(this.telephoneNumbers, assemblyOscalMetadataLocation.telephoneNumbers) &&
        Objects.equals(this.urls, assemblyOscalMetadataLocation.urls) &&
        Objects.equals(this.props, assemblyOscalMetadataLocation.props) &&
        Objects.equals(this.links, assemblyOscalMetadataLocation.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataLocation.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataLocation {\n");
