...
public class Citation1   {
  ...
  public Citation1 text(String text) {
    this.text = text;
    return this;
  }
  ...
  public Citation1 props(List<AssemblyOscalMetadataProperty1> props) {
    this.props = props;
    return this;
  }

  public Citation1 addPropsItem(AssemblyOscalMetadataProperty1 propsItem) {
    if (this.props == null) {
  ...
  public Citation1 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public Citation1 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Citation1 citation1 = (Citation1) o;
    return Objects.equals(this.text, citation1.text) &&
        Objects.equals(this.props, citation1.props) &&
        Objects.equals(this.links, citation1.links);
  }
