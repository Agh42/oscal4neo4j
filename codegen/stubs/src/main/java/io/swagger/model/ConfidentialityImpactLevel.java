 ...
 */
@Schema(description = "The expected level of impact resulting from the unauthorized disclosure of the described information.")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2022-02-24T08:30:46.962624+01:00[Europe/Berlin]")


public class ConfidentialityImpactLevel   {
  @JsonProperty("props")
  @Valid
  ...
  public ConfidentialityImpactLevel props(List<AssemblyOscalMetadataProperty3> props) {
    this.props = props;
    return this;
  }

  public ConfidentialityImpactLevel addPropsItem(AssemblyOscalMetadataProperty3 propsItem) {
    if (this.props == null) {
  ...
  public ConfidentialityImpactLevel links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public ConfidentialityImpactLevel addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public ConfidentialityImpactLevel base(String base) {
    this.base = base;
    return this;
  }
  ...
  public ConfidentialityImpactLevel selected(String selected) {
  ...
  public ConfidentialityImpactLevel adjustmentJustification(String adjustmentJustification) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfidentialityImpactLevel confidentialityImpactLevel = (ConfidentialityImpactLevel) o;
    return Objects.equals(this.props, confidentialityImpactLevel.props) &&
        Objects.equals(this.links, confidentialityImpactLevel.links) &&
        Objects.equals(this.base, confidentialityImpactLevel.base) &&
        Objects.equals(this.selected, confidentialityImpactLevel.selected) &&
        Objects.equals(this.adjustmentJustification, confidentialityImpactLevel.adjustmentJustification);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfidentialityImpactLevel {\n");
