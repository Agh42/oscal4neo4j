...
public class AssemblyOscalMetadataRole   {
  @JsonProperty("id")
  ...
  public AssemblyOscalMetadataRole id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AssemblyOscalMetadataRole title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AssemblyOscalMetadataRole shortName(String shortName) {
  ...
  public AssemblyOscalMetadataRole description(String description) {
  ...
  public AssemblyOscalMetadataRole props(List<AssemblyOscalMetadataProperty> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataRole addPropsItem(AssemblyOscalMetadataProperty propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataRole links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataRole addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataRole remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataRole assemblyOscalMetadataRole = (AssemblyOscalMetadataRole) o;
    return Objects.equals(this.id, assemblyOscalMetadataRole.id) &&
        Objects.equals(this.title, assemblyOscalMetadataRole.title) &&
        Objects.equals(this.shortName, assemblyOscalMetadataRole.shortName) &&
        Objects.equals(this.description, assemblyOscalMetadataRole.description) &&
        Objects.equals(this.props, assemblyOscalMetadataRole.props) &&
        Objects.equals(this.links, assemblyOscalMetadataRole.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataRole.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataRole {\n");
