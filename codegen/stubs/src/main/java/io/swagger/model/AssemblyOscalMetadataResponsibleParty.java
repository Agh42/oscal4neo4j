...
public class AssemblyOscalMetadataResponsibleParty   {
  ...
  public AssemblyOscalMetadataResponsibleParty roleId(String roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public AssemblyOscalMetadataResponsibleParty partyUuids(List<String> partyUuids) {
    this.partyUuids = partyUuids;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty addPartyUuidsItem(String partyUuidsItem) {
  ...
  public AssemblyOscalMetadataResponsibleParty props(List<AssemblyOscalMetadataProperty> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty addPropsItem(AssemblyOscalMetadataProperty propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataResponsibleParty links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataResponsibleParty remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataResponsibleParty assemblyOscalMetadataResponsibleParty = (AssemblyOscalMetadataResponsibleParty) o;
    return Objects.equals(this.roleId, assemblyOscalMetadataResponsibleParty.roleId) &&
        Objects.equals(this.partyUuids, assemblyOscalMetadataResponsibleParty.partyUuids) &&
        Objects.equals(this.props, assemblyOscalMetadataResponsibleParty.props) &&
        Objects.equals(this.links, assemblyOscalMetadataResponsibleParty.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataResponsibleParty.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataResponsibleParty {\n");
