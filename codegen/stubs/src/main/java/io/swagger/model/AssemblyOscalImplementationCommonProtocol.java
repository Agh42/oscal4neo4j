...
public class AssemblyOscalImplementationCommonProtocol   {
  @JsonProperty("uuid")
  ...
  public AssemblyOscalImplementationCommonProtocol uuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AssemblyOscalImplementationCommonProtocol name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssemblyOscalImplementationCommonProtocol title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AssemblyOscalImplementationCommonProtocol portRanges(List<AssemblyOscalImplementationCommonPortRange> portRanges) {
    this.portRanges = portRanges;
    return this;
  }

  public AssemblyOscalImplementationCommonProtocol addPortRangesItem(AssemblyOscalImplementationCommonPortRange portRangesItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalImplementationCommonProtocol assemblyOscalImplementationCommonProtocol = (AssemblyOscalImplementationCommonProtocol) o;
    return Objects.equals(this.uuid, assemblyOscalImplementationCommonProtocol.uuid) &&
        Objects.equals(this.name, assemblyOscalImplementationCommonProtocol.name) &&
        Objects.equals(this.title, assemblyOscalImplementationCommonProtocol.title) &&
        Objects.equals(this.portRanges, assemblyOscalImplementationCommonProtocol.portRanges);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalImplementationCommonProtocol {\n");
