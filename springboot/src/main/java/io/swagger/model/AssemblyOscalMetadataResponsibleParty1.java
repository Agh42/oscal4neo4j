...
public class AssemblyOscalMetadataResponsibleParty1   {
  ...
  public AssemblyOscalMetadataResponsibleParty1 roleId(String roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public AssemblyOscalMetadataResponsibleParty1 partyUuids(List<String> partyUuids) {
    this.partyUuids = partyUuids;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty1 addPartyUuidsItem(String partyUuidsItem) {
  ...
  public AssemblyOscalMetadataResponsibleParty1 props(List<AssemblyOscalMetadataProperty1> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty1 addPropsItem(AssemblyOscalMetadataProperty1 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataResponsibleParty1 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty1 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataResponsibleParty1 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataResponsibleParty1 assemblyOscalMetadataResponsibleParty1 = (AssemblyOscalMetadataResponsibleParty1) o;
    return Objects.equals(this.roleId, assemblyOscalMetadataResponsibleParty1.roleId) &&
        Objects.equals(this.partyUuids, assemblyOscalMetadataResponsibleParty1.partyUuids) &&
        Objects.equals(this.props, assemblyOscalMetadataResponsibleParty1.props) &&
        Objects.equals(this.links, assemblyOscalMetadataResponsibleParty1.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataResponsibleParty1.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataResponsibleParty1 {\n");
