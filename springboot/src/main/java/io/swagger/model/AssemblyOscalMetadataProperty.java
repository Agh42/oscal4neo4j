...
public class AssemblyOscalMetadataProperty   {
  @JsonProperty("name")
  ...
  public AssemblyOscalMetadataProperty name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssemblyOscalMetadataProperty uuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AssemblyOscalMetadataProperty ns(String ns) {
    this.ns = ns;
    return this;
  }
  ...
  public AssemblyOscalMetadataProperty value(String value) {
    this.value = value;
    return this;
  }
  ...
  public AssemblyOscalMetadataProperty propertyClass(String propertyClass) {
  ...
  public AssemblyOscalMetadataProperty remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataProperty assemblyOscalMetadataProperty = (AssemblyOscalMetadataProperty) o;
    return Objects.equals(this.name, assemblyOscalMetadataProperty.name) &&
        Objects.equals(this.uuid, assemblyOscalMetadataProperty.uuid) &&
        Objects.equals(this.ns, assemblyOscalMetadataProperty.ns) &&
        Objects.equals(this.value, assemblyOscalMetadataProperty.value) &&
        Objects.equals(this.propertyClass, assemblyOscalMetadataProperty.propertyClass) &&
        Objects.equals(this.remarks, assemblyOscalMetadataProperty.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataProperty {\n");
