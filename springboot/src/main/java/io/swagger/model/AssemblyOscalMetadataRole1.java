...
public class AssemblyOscalMetadataRole1   {
  @JsonProperty("id")
  ...
  public AssemblyOscalMetadataRole1 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AssemblyOscalMetadataRole1 title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AssemblyOscalMetadataRole1 shortName(String shortName) {
  ...
  public AssemblyOscalMetadataRole1 description(String description) {
  ...
  public AssemblyOscalMetadataRole1 props(List<AssemblyOscalMetadataProperty1> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataRole1 addPropsItem(AssemblyOscalMetadataProperty1 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataRole1 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataRole1 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataRole1 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataRole1 assemblyOscalMetadataRole1 = (AssemblyOscalMetadataRole1) o;
    return Objects.equals(this.id, assemblyOscalMetadataRole1.id) &&
        Objects.equals(this.title, assemblyOscalMetadataRole1.title) &&
        Objects.equals(this.shortName, assemblyOscalMetadataRole1.shortName) &&
        Objects.equals(this.description, assemblyOscalMetadataRole1.description) &&
        Objects.equals(this.props, assemblyOscalMetadataRole1.props) &&
        Objects.equals(this.links, assemblyOscalMetadataRole1.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataRole1.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataRole1 {\n");
