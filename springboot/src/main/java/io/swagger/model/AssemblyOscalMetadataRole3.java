...
public class AssemblyOscalMetadataRole3   {
  @JsonProperty("id")
  ...
  public AssemblyOscalMetadataRole3 id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AssemblyOscalMetadataRole3 title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AssemblyOscalMetadataRole3 shortName(String shortName) {
  ...
  public AssemblyOscalMetadataRole3 description(String description) {
  ...
  public AssemblyOscalMetadataRole3 props(List<AssemblyOscalMetadataProperty3> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataRole3 addPropsItem(AssemblyOscalMetadataProperty3 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataRole3 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataRole3 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataRole3 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataRole3 assemblyOscalMetadataRole3 = (AssemblyOscalMetadataRole3) o;
    return Objects.equals(this.id, assemblyOscalMetadataRole3.id) &&
        Objects.equals(this.title, assemblyOscalMetadataRole3.title) &&
        Objects.equals(this.shortName, assemblyOscalMetadataRole3.shortName) &&
        Objects.equals(this.description, assemblyOscalMetadataRole3.description) &&
        Objects.equals(this.props, assemblyOscalMetadataRole3.props) &&
        Objects.equals(this.links, assemblyOscalMetadataRole3.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataRole3.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataRole3 {\n");
