...
public class AssemblyOscalMetadataParty1   {
  @JsonProperty("uuid")
  ...
  @Valid
  private List<AssemblyOscalMetadataAddress1> addresses = null;
  ...
  public AssemblyOscalMetadataParty1 uuid(String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AssemblyOscalMetadataParty1 type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public AssemblyOscalMetadataParty1 name(String name) {
    this.name = name;
    return this;
  }
  ...
  public AssemblyOscalMetadataParty1 shortName(String shortName) {
  ...
  public AssemblyOscalMetadataParty1 externalIds(List<PartyExternalIdentifier> externalIds) {
    this.externalIds = externalIds;
    return this;
  }

  public AssemblyOscalMetadataParty1 addExternalIdsItem(PartyExternalIdentifier externalIdsItem) {
  ...
  public AssemblyOscalMetadataParty1 props(List<AssemblyOscalMetadataProperty1> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataParty1 addPropsItem(AssemblyOscalMetadataProperty1 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataParty1 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataParty1 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataParty1 emailAddresses(List<String> emailAddresses) {
    this.emailAddresses = emailAddresses;
    return this;
  }

  public AssemblyOscalMetadataParty1 addEmailAddressesItem(String emailAddressesItem) {
  ...
  public AssemblyOscalMetadataParty1 telephoneNumbers(List<FieldOscalMetadataTelephoneNumber> telephoneNumbers) {
    this.telephoneNumbers = telephoneNumbers;
    return this;
  }

  public AssemblyOscalMetadataParty1 addTelephoneNumbersItem(FieldOscalMetadataTelephoneNumber telephoneNumbersItem) {
  ...
  public AssemblyOscalMetadataParty1 addresses(List<AssemblyOscalMetadataAddress1> addresses) {
    this.addresses = addresses;
    return this;
  }

  public AssemblyOscalMetadataParty1 addAddressesItem(AssemblyOscalMetadataAddress1 addressesItem) {
    if (this.addresses == null) {
      this.addresses = new ArrayList<AssemblyOscalMetadataAddress1>();
    }
  ...
  @Schema(description = "")
      @Valid
  @Size(min=1)   public List<AssemblyOscalMetadataAddress1> getAddresses() {
    return addresses;
  }

  public void setAddresses(List<AssemblyOscalMetadataAddress1> addresses) {
    this.addresses = addresses;
  }

  public AssemblyOscalMetadataParty1 locationUuids(List<String> locationUuids) {
    this.locationUuids = locationUuids;
    return this;
  }

  public AssemblyOscalMetadataParty1 addLocationUuidsItem(String locationUuidsItem) {
  ...
  public AssemblyOscalMetadataParty1 memberOfOrganizations(List<String> memberOfOrganizations) {
    this.memberOfOrganizations = memberOfOrganizations;
    return this;
  }

  public AssemblyOscalMetadataParty1 addMemberOfOrganizationsItem(String memberOfOrganizationsItem) {
  ...
  public AssemblyOscalMetadataParty1 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataParty1 assemblyOscalMetadataParty1 = (AssemblyOscalMetadataParty1) o;
    return Objects.equals(this.uuid, assemblyOscalMetadataParty1.uuid) &&
        Objects.equals(this.type, assemblyOscalMetadataParty1.type) &&
        Objects.equals(this.name, assemblyOscalMetadataParty1.name) &&
        Objects.equals(this.shortName, assemblyOscalMetadataParty1.shortName) &&
        Objects.equals(this.externalIds, assemblyOscalMetadataParty1.externalIds) &&
        Objects.equals(this.props, assemblyOscalMetadataParty1.props) &&
        Objects.equals(this.links, assemblyOscalMetadataParty1.links) &&
        Objects.equals(this.emailAddresses, assemblyOscalMetadataParty1.emailAddresses) &&
        Objects.equals(this.telephoneNumbers, assemblyOscalMetadataParty1.telephoneNumbers) &&
        Objects.equals(this.addresses, assemblyOscalMetadataParty1.addresses) &&
        Objects.equals(this.locationUuids, assemblyOscalMetadataParty1.locationUuids) &&
        Objects.equals(this.memberOfOrganizations, assemblyOscalMetadataParty1.memberOfOrganizations) &&
        Objects.equals(this.remarks, assemblyOscalMetadataParty1.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataParty1 {\n");
