...
public class AssemblyOscalMetadataResponsibleRole1   {
  ...
  public AssemblyOscalMetadataResponsibleRole1 roleId(String roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public AssemblyOscalMetadataResponsibleRole1 props(List<AssemblyOscalMetadataProperty3> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataResponsibleRole1 addPropsItem(AssemblyOscalMetadataProperty3 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataResponsibleRole1 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataResponsibleRole1 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataResponsibleRole1 partyUuids(List<String> partyUuids) {
    this.partyUuids = partyUuids;
    return this;
  }

  public AssemblyOscalMetadataResponsibleRole1 addPartyUuidsItem(String partyUuidsItem) {
  ...
  public AssemblyOscalMetadataResponsibleRole1 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataResponsibleRole1 assemblyOscalMetadataResponsibleRole1 = (AssemblyOscalMetadataResponsibleRole1) o;
    return Objects.equals(this.roleId, assemblyOscalMetadataResponsibleRole1.roleId) &&
        Objects.equals(this.props, assemblyOscalMetadataResponsibleRole1.props) &&
        Objects.equals(this.links, assemblyOscalMetadataResponsibleRole1.links) &&
        Objects.equals(this.partyUuids, assemblyOscalMetadataResponsibleRole1.partyUuids) &&
        Objects.equals(this.remarks, assemblyOscalMetadataResponsibleRole1.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataResponsibleRole1 {\n");
