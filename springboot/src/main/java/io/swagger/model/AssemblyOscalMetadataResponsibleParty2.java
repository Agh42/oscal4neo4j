...
public class AssemblyOscalMetadataResponsibleParty2   {
  ...
  public AssemblyOscalMetadataResponsibleParty2 roleId(String roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public AssemblyOscalMetadataResponsibleParty2 partyUuids(List<String> partyUuids) {
    this.partyUuids = partyUuids;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty2 addPartyUuidsItem(String partyUuidsItem) {
  ...
  public AssemblyOscalMetadataResponsibleParty2 props(List<AssemblyOscalMetadataProperty2> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty2 addPropsItem(AssemblyOscalMetadataProperty2 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataResponsibleParty2 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataResponsibleParty2 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataResponsibleParty2 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataResponsibleParty2 assemblyOscalMetadataResponsibleParty2 = (AssemblyOscalMetadataResponsibleParty2) o;
    return Objects.equals(this.roleId, assemblyOscalMetadataResponsibleParty2.roleId) &&
        Objects.equals(this.partyUuids, assemblyOscalMetadataResponsibleParty2.partyUuids) &&
        Objects.equals(this.props, assemblyOscalMetadataResponsibleParty2.props) &&
        Objects.equals(this.links, assemblyOscalMetadataResponsibleParty2.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataResponsibleParty2.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataResponsibleParty2 {\n");
