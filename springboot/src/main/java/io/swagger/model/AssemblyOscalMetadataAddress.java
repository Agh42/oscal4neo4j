...
public class AssemblyOscalMetadataAddress   {
  @JsonProperty("type")
  ...
  public AssemblyOscalMetadataAddress type(String type) {
    this.type = type;
    return this;
  }
  ...
  public AssemblyOscalMetadataAddress addrLines(List<String> addrLines) {
    this.addrLines = addrLines;
    return this;
  }

  public AssemblyOscalMetadataAddress addAddrLinesItem(String addrLinesItem) {
  ...
  public AssemblyOscalMetadataAddress city(String city) {
    this.city = city;
    return this;
  }
  ...
  public AssemblyOscalMetadataAddress state(String state) {
    this.state = state;
    return this;
  }
  ...
  public AssemblyOscalMetadataAddress postalCode(String postalCode) {
  ...
  public AssemblyOscalMetadataAddress country(String country) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataAddress assemblyOscalMetadataAddress = (AssemblyOscalMetadataAddress) o;
    return Objects.equals(this.type, assemblyOscalMetadataAddress.type) &&
        Objects.equals(this.addrLines, assemblyOscalMetadataAddress.addrLines) &&
        Objects.equals(this.city, assemblyOscalMetadataAddress.city) &&
        Objects.equals(this.state, assemblyOscalMetadataAddress.state) &&
        Objects.equals(this.postalCode, assemblyOscalMetadataAddress.postalCode) &&
        Objects.equals(this.country, assemblyOscalMetadataAddress.country);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataAddress {\n");
