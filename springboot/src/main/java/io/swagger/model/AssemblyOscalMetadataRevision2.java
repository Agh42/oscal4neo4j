...
public class AssemblyOscalMetadataRevision2   {
  @JsonProperty("title")
  ...
  public AssemblyOscalMetadataRevision2 title(String title) {
    this.title = title;
    return this;
  }
  ...
  public AssemblyOscalMetadataRevision2 published(OffsetDateTime published) {
  ...
  public AssemblyOscalMetadataRevision2 lastModified(OffsetDateTime lastModified) {
  ...
  public AssemblyOscalMetadataRevision2 version(String version) {
  ...
  public AssemblyOscalMetadataRevision2 oscalVersion(String oscalVersion) {
  ...
  public AssemblyOscalMetadataRevision2 props(List<AssemblyOscalMetadataProperty2> props) {
    this.props = props;
    return this;
  }

  public AssemblyOscalMetadataRevision2 addPropsItem(AssemblyOscalMetadataProperty2 propsItem) {
    if (this.props == null) {
  ...
  public AssemblyOscalMetadataRevision2 links(List<AssemblyOscalMetadataLink> links) {
    this.links = links;
    return this;
  }

  public AssemblyOscalMetadataRevision2 addLinksItem(AssemblyOscalMetadataLink linksItem) {
    if (this.links == null) {
  ...
  public AssemblyOscalMetadataRevision2 remarks(String remarks) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssemblyOscalMetadataRevision2 assemblyOscalMetadataRevision2 = (AssemblyOscalMetadataRevision2) o;
    return Objects.equals(this.title, assemblyOscalMetadataRevision2.title) &&
        Objects.equals(this.published, assemblyOscalMetadataRevision2.published) &&
        Objects.equals(this.lastModified, assemblyOscalMetadataRevision2.lastModified) &&
        Objects.equals(this.version, assemblyOscalMetadataRevision2.version) &&
        Objects.equals(this.oscalVersion, assemblyOscalMetadataRevision2.oscalVersion) &&
        Objects.equals(this.props, assemblyOscalMetadataRevision2.props) &&
        Objects.equals(this.links, assemblyOscalMetadataRevision2.links) &&
        Objects.equals(this.remarks, assemblyOscalMetadataRevision2.remarks);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssemblyOscalMetadataRevision2 {\n");
