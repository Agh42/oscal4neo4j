...
public interface ComponentDefinitionsApi {
  ...
  @Operation(
      ...
      tags = {"OSCAL Component Definition"})
  @ApiResponses(
      value = {
  ...
  ResponseEntity<Void> addComponentControlImplementationToComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component definition ID",
              required = true,
              schema = @Schema())
          @PathVariable("componentDefinitionId")
      ...
      @Parameter(
          ...
          @Valid
          @RequestBody
          OSCALComponentDefinitionComponentControlImplementation body,
  ...
  @RequestMapping(
      ...
      consumes = {"application/json"},
      method = RequestMethod.POST)
  ResponseEntity<Void> addComponentDefinition(
      @Parameter(
              in = ParameterIn.DEFAULT,
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}/components",
      consumes = {"application/json"},
      method = RequestMethod.POST)
  ResponseEntity<Void> addComponentToComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component definition ID",
              required = true,
      ...
      @Parameter(
          ...
          @Valid
          @RequestBody
          OSCALComponentDefinitionComponent body,
      @Parameter(in = ParameterIn.HEADER, description = "", schema = @Schema())
          @RequestHeader(value = "api_key", required = false)
          String apiKey);
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}/parties/{partyId}",
      method = RequestMethod.PUT)
  ResponseEntity<Void> addPartyToComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component Definition ID",
              required = true,
  ...
  @RequestMapping(
      ...
      method = RequestMethod.POST)
  ResponseEntity<Void> addPartyToComponentDefinitionRole(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component Definition ID",
              required = true,
      ...
      @Parameter(
              in = ParameterIn.PATH,
              description =
                  "Role ID for the party to be associated with within the component definition",
              required = true,
              schema = @Schema())
          @PathVariable("roleId")
          String roleId,
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}/roles",
      consumes = {"application/json"},
      method = RequestMethod.POST)
  ResponseEntity<Void> addRoleToComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component definition ID",
              required = true,
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}",
      method = RequestMethod.DELETE)
  ResponseEntity<Void> deleteComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
        ...
        @ApiResponse(
            ...
            content =
                @Content(
                    ...
                    array =
                        @ArraySchema(
                            schema = @Schema(implementation = OSCALComponentDefinition.class)))),
  ...
  ResponseEntity<List<OSCALComponentDefinition>> findComponentDefinitionsByName(
      @NotNull
          @Parameter(
  ...
  @RequestMapping(
      ...
      produces = {"application/json"},
      method = RequestMethod.GET)
  ResponseEntity<OSCALComponentDefinition> getComponentDefinitionById(
      @Parameter(
              in = ParameterIn.PATH,
  ...
  @RequestMapping(
      ...
      method = RequestMethod.DELETE)
  ResponseEntity<Void> removeComponentControlImplementationFromComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component Definition ID",
              required = true,
      ...
      @Parameter(
              in = ParameterIn.PATH,
              description =
                  "Component control implementation ID to be removed from the component definition",
              required = true,
              schema = @Schema())
          @PathVariable("componentControlImplementationId")
          String componentControlImplementationId,
      @Parameter(in = ParameterIn.HEADER, description = "", schema = @Schema())
          @RequestHeader(value = "api_key", required = false)
          String apiKey);
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}/components/{componentId}",
      method = RequestMethod.DELETE)
  ResponseEntity<Void> removeComponentFromComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component Definition ID",
              required = true,
  ...
  @Operation(
      ...
      description =
          "Removes the given party from the given component definition.  This should also result in references under other parts of the schema such as   component responsible roles being removed. ",
      security = {
        @SecurityRequirement(
            name = "oscal_auth",
            scopes = {
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}/parties/{partyId}",
      method = RequestMethod.DELETE)
  ResponseEntity<Void> removePartyFromComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component Definition ID",
              required = true,
  ...
  @RequestMapping(
      value =
          "/component-definitions/{componentDefinitionId}/responsible-parties/{roleId}/parties/{partyId}",
      method = RequestMethod.DELETE)
  ResponseEntity<Void> removePartyFromComponentDefinitionRole(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component definition ID",
              required = true,
      ...
      @Parameter(
              in = ParameterIn.PATH,
              description =
                  "Role ID within the component definition the party should be removed from",
              required = true,
              schema = @Schema())
          @PathVariable("roleId")
          String roleId,
  ...
  @Operation(
      ...
      description =
          "Removes the given role from the given component definition.  This should also result in references under other parts of the schema such as responsible parties being removed. ",
      security = {
        @SecurityRequirement(
            name = "oscal_auth",
            scopes = {
  ...
  @RequestMapping(
      value = "/component-definitions/{componentDefinitionId}/roles/{roleId}",
      method = RequestMethod.DELETE)
  ResponseEntity<Void> removeRoleFromComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component Definition ID",
              required = true,
  ...
  @Operation(
      summary =
          "Updates an existing control implementation in a component in an OSCAL component definition",
      description = "",
      security = {
        @SecurityRequirement(
            name = "oscal_auth",
  ...
  ResponseEntity<Void> updateComponentControlImplementationInComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component definition ID",
              required = true,
      ...
      @Parameter(
              in = ParameterIn.PATH,
              description =
                  "Component control implementation ID to be updated in the component definition",
              required = true,
              schema = @Schema())
          @PathVariable("componentControlImplementationId")
          String componentControlImplementationId,
  ...
  @RequestMapping(
      ...
      consumes = {"application/json"},
      method = RequestMethod.PATCH)
  ResponseEntity<Void> updateComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "ID of component definition to return",
              required = true,
      ...
      @Parameter(
          ...
          @Valid
          @RequestBody
          OSCALComponentDefinitionUpdateExample body);
  ...
  @RequestMapping(
      ...
      consumes = {"application/json"},
      method = RequestMethod.PATCH)
  ResponseEntity<Void> updateComponentInComponentDefinition(
      @Parameter(
              in = ParameterIn.PATH,
              description = "Component definition ID",
              required = true,
